        ...
        <div class="nav-right col-xs-12 col-md-10 padding-right-clear">
            <div class="bill_box rightarea padding-right-clear record account-box">
                <section class="trade-group merchant-top">
                    ...
                    <span class="tips-word">{{$t("ucenter.shimingzhiid")}}</span>
                    <span class="tips-g">{{$t("ucenter.shezhishimingzhiid")}}</span>
                </section>
                    ...
                    <div class="account-in">
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <span class="card-number">{{$t("ucenter.bankaccount")}}</span>
                                ...
                                <a class="btn" v-if="user.bankVerified==1" @click="noName">{{$t("ucenter.Edit")}}</a>
                                <a class="btn" v-else @click="showItem(1)">{{$t("ucenter.bing")}}</a>
                            </div>
                            <div class="account-detail" v-show="choseItem==1">
                                <div class="detail-list">
                                    <Form ref="formValidate1" :model="formValidate1" :rules="ruleValidate" :label-width="85">
                                        ...
                                        <!-- Button -->
                                        <FormItem>
                                            <Button type="primary" @click="handleSubmit('formValidate1')">{{$t("ucenter.save")}}</Button>
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <span class="card-number">{{$t("ucenter.zhifubaoAccount")}}</span>
                                <p v-if="user.aliVerified==1" class="bankInfo" style="color: grey;">
                                    {{user.alipay.aliNo}}
                                </p>
                                <p v-else class="bankInfo" style="color: grey;">
                                    {{$t("ucenter.zhifubaoAccount")}}
                                </p>
                                <a class="btn" v-if="user.aliVerified==1" @click="noName">{{$t("ucenter.Edit")}}</a>
                                <a class="btn" v-else @click="showItem(2)">{{$t("ucenter.bing")}}</a>
                            </div>
                            <div class="account-detail" v-show="choseItem==2">
                                <div class="detail-list">
                                    <Form ref="formValidate2" :model="formValidate2" :rules="ruleValidate" :label-width="85">
                                        ...
                                        <!-- Button -->
                                        <FormItem>
                                            <Button type="primary" @click="handleSubmit('formValidate2')">{{$t("ucenter.save")}}</Button>
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <span class="card-number">{{$t("ucenter.wecharAccount")}}</span>
                                <p v-if="user.wechatVerified==1" class="bankInfo" style="color: grey;">
                                    {{user.wechatPay.wechat}}
                                </p>
                                <p v-else class="bankInfo" style="color: grey;">
                                  {{$t("ucenter.iswechaeAccount")}}  
                                </p>
                                <a class="btn" v-if="user.wechatVerified==1" @click="noName">{{$t("ucenter.Edit")}}</a>
                                <a class="btn" v-else @click="showItem(3)">{{$t("ucenter.bing")}}</a>
                            </div>
                            <div class="account-detail" v-show="choseItem==3">
                                <div class="detail-list">
                                    <Form ref="formValidate3" :model="formValidate3" :rules="ruleValidate" :label-width="85">
                                        ...
                                        <!-- Button -->
                                        <FormItem>
                                            <Button type="primary" @click="handleSubmit('formValidate3')">{{$t("ucenter.save")}}</Button>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            ruleValidate: {
                name: [
                    { required: true, message: '请先进行实名认证', trigger: 'blur' }
                ],
                bankName: [
        ...
        getAccount() {
            ...
            this.$http.post(this.host + '/uc/approve/account/setting').then(response => {
                ...
                if (resp.code == 0) {
                    ...
                    //设置
                    this.formValidate1.bankName = this.user.bankInfo.bank
                    this.formValidate1.bankBranch = this.user.bankInfo.branch
                    this.formValidate1.bankNo = this.user.bankInfo.cardNo
                    this.formValidate2.alipay = this.user.alipay.aliNo
                    this.formValidate3.wechat = this.user.wechatPay.wechat
