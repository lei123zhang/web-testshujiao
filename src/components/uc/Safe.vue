                    ...
                    <div class="account-in">
                        ...
                        <div class="account-item" style="display:none">
                            <div class="account-item-in">
                                ...
                                <span class="card-number">{{$t('uc.safe.safelevel_nickname')}}</span>
                                <p class="bankInfo" style="color: grey;">
                                    bearbaby
                                </p>
                                <span>{{$t('uc.safe.safelevel_binded')}}</span>
                            </div>
                        </div>
                        <!-- 6 -->
                                ...
                                <div class="detail-list" style="width: 100%;">
                                    <Form ref="formValidate6" :model="formValidate6" :rules="ruleValidate" :label-width="85">
                                        ...
                                        <FormItem>
                                            ...
                                            <Button type="ghost" @click="handleReset('formValidate6')" style="margin-left: 8px">{{$t('uc.safe.reset')}}</Button>
                                        </FormItem>
                                    </Form>
                                </div>
                            </div>
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <a class="btn" v-if="user.fundsVerified==1 &&user.phoneVerified==0" @click="noPhone">{{$t('uc.safe.set')}}</a>
                                <a class="btn" v-else @click="showItem(5)">{{$t('uc.safe.edit')}}</a>
                            </div>
...
<script>
import  frontCardImg from '../../assets/images/frontCardImg.png'
import  backCardImg  from '../../assets/images/backCardImg.png'
import handCardImg  from '../../assets/images/handCardImg.png'
export default {
    components: {
    },
    data() {
        ...
        const validateMPassCheck = (rule, value, callback) => {
            if (value === '') {
                ...
                callback(new Error(this.$t('uc.safe.pwdmsg')));
            } else {
                callback();
            }
        };
