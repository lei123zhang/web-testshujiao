  ...
  export default {
    data() {
      return {
        ...
        time:"2018-03-06",
        content:'<h4 class="h4">《Ex交易平台服务协议》（以下简称“本协议”）是久财网全球专业站（www.***.com）（以下\n' +
        '          简称“本网站”）用户协议的补充部分，适用于本网站的下属子网站久财网全球专业站法币交易平台（otc.huobi.pro）\n' +
        '          服务。本网站的用户协议及其他条款继续适用于本网站所有用户。在您通过本网站继续下一步操作前，请您务必仔细阅 读并透彻理解本协议。如您通过本网站继续下一步操作，或以任何方式使用EX全球专业站法 币交易平台交易服务，\n' +
