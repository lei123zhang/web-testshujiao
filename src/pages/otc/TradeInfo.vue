                                ...
                                <div class="trade-price-input">
                                    <p class="price-input-list">
                                        <Poptip trigger="focus" :content="text1" style="width: 100%;">
                                            <Input @on-change="transform1" v-model="buyPrice" size="large" placeholder="请输入金额" style="width: 420px">
                                    ...
                                    <p class="price-input-list">
                                        <Poptip trigger="focus" :content="text2" style="width: 100%;">
                                            <Input @on-change="transform2" v-model="nuyNum" size="large" placeholder="请输入数量" style="width: 420px" readonly>
