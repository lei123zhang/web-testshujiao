module.exports = {
    ...
    service: {
        ...
        newHelp: "New user helping",
        appDownload: "Download App",
        CommonProblems: "FAQ",
        CallNoticeCenter: "FAQ->notice",
    },
    serviceindex: {
        USDT: 'USDT Service',
        BTC: 'BTC Service',
    ...
    ucenter: {
        safetylevellow: "Security Level: Low",
        safetylevelcentre: "Security Level: Medium",
        safetylevelhigh: "Security Level: High",
        name: "Nickname",
        binding: "Binded",
        bing: "Bind",
        Certification: "verified",
        auditing: "Bindind",
        Anquan: "To protect your account security, please complete real-name certification before you can trade operations!",
        idtop: "Upload photo ID front",
        idbottom: "Upload ID card reverse photo",
        shimingzhiid: "Bind real name account",
        shezhishimingzhiid: "Please set up your collection mode, please use my real name account.",
        bankaccount: "Bank account",
        idNobing: "Personal bank card information is not bound",
        Edit: "Edit",
        save: "Save",
        zhifubaoAccount: "Alipay account",
        isnozhifubaoAccount: "Personal Alipay account is not bound",
        wecharAccount: "Wechat account",
        iswechaeAccount: "Personal Wechat account is not bound"
    },
    asset: {
        personal: "Personal assets",
        billingDetails: "Bill detail",
        Chargemoney: "charge",
        MentionMoney: "Pick up",
        money:{
            cointype:'Coin',
            balance:'Balance',
          ...
          withdraw:{
            ...
            tip1:'Enter up to 6 decimal places and the minimum value is',
    ...
    uc:{
      login:{
        ...
        loginvalidate:'Please input tel or email',
    ...
    footer: {
        gsmc:'Shanghai Satuxi Network Co. Ltd',
    ...
    index: {
        slogan: "From the fingertip, square inch, easy trade.",//首页的下载APP的广告语
        Appslogan: "Welcome to use the Ex. Biz mobile client APP."//首页的下载APP的广告语
    },
   
    peakfire: {
        mailboxleft: "Please send the following materials by email.",
        mailboxcenter: "*****@**.com，",
